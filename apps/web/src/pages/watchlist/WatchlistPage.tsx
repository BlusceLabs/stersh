    ...
    <main className="relative min-h-screen bg-background text-foreground">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 pt-32 pb-40">
        <div className="flex items-center justify-between">
          <h1 className="text-4xl font-bold tracking-tight md:text-5xl">Watchlist</h1>
        ...
        {items.length === 0 ? (
          <div className="mt-20 flex flex-col items-center text-center">
            <div className="flex h-20 w-20 items-center justify-center rounded-full bg-muted">
              <Clapperboard size={36} className="text-muted-foreground/40" />
            </div>
            <p className="mt-6 text-lg text-muted-foreground">Your watchlist is empty</p>
            <p className="mt-2 text-sm text-muted-foreground/50">
              Browse movies and TV shows, then add them here
            </p>
            <Button
